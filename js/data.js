    ...
    inner: [
      {
        name: "Dashboards",
        slug: "dashboards",
        tip: "Painéis e indicadores para acompanhar o negócio.",
      },
      {
        name: "Painéis Administrativos",
        slug: "paineis-administrativos",
        tip: "Gestão interna com controle e organização.",
      },
      {
        name: "Banco de Dados",
        slug: "banco-de-dados",
        tip: "Estrutura de dados confiável para o sistema.",
      },
      {
        name: "Chatbot",
        slug: "chatbot",
        tip: "Atendimento automatizado e suporte 24h.",
      },
    ],
    mid: [
      {
        name: "Cardápios Digitais",
        slug: "cardapios-digitais",
        tip: "Cardápios online com pedidos e integração Pix.",
      },
      {
        name: "Sistemas Internos",
        slug: "sistemas-internos",
        tip: "Ferramentas internas para o dia a dia da operação.",
      },
      {
        name: "Integrações com APIs",
        slug: "integracoes-apis",
        tip: "Conexão entre sistemas e serviços externos.",
      },
      {
        name: "Sistemas Personalizados",
        slug: "sistemas-personalizados",
        tip: "Soluções sob medida para o seu processo.",
      },
      {
        name: "Integrações externas",
        slug: "integracoes-externas",
        tip: "Conexão com ferramentas e plataformas de terceiros.",
      },
      {
        name: "Domínio / hospedagem",
        slug: "dominio-hospedagem",
        tip: "Publicação estável do site e do sistema.",
      },
    ],
    outer: [
      {
        name: "E-commerce",
        slug: "ecommerce",
        tip: "Lojas online para vender com clareza e escala.",
      },
      {
        name: "Automação",
        slug: "automacao",
        tip: "Rotinas e processos que rodam sozinhos.",
      },
      {
        name: "Área do Cliente",
        slug: "area-do-cliente",
        tip: "Portal para o cliente acompanhar e solicitar.",
      },
      {
        name: "Site Institucional",
        slug: "site-institucional",
        tip: "Presença digital clara e profissional.",
      },
      {
        name: "Landing Page",
        slug: "landing-page",
        tip: "Páginas focadas em conversão e campanhas.",
      },
      {
        name: "Portfólio Avançado",
        slug: "portfolio-avancado",
        tip: "Vitrine de trabalhos com impacto visual.",
      },
      {
        name: "Manutenção evolutiva",
        slug: "manutencao-evolutiva",
        tip: "Evolução contínua do produto após o lançamento.",
      },
      {
        name: "Identidade visual",
        slug: "identidade-visual",
        tip: "Marca e interface alinhadas à sua comunicação.",
      },
      {
        name: "Inteligência Artificial",
        slug: "inteligencia-artificial",
        tip: "Recursos de IA para agilizar e personalizar.",
      },
    ],
  },
};
